...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu" style="margin: 5px 0px;">
			...
			<li><a style="background:#337ab7;color: #fff;font-size: 18px;"><i class="fa fa-chevron-circle-right" aria-hidden="true"></i> Quản lý khách hàng</a></li>
			<li id="users"><a href="{{route('user')}}"><i class="fa fa-users" aria-hidden="true"></i> Khách hàng</a></li>
		</ul>
	</div>
	<!--/.sidebar-->
