            ...
            <div class="customer_login">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6" style="margin-left: 300px;">
                        ...
                        <div class="row"><a style="font-size: 20px;margin-left: 15px;color: #018576;">Chưa có tài khoản</a><a href="{{route('register')}}" style="font-size: 16px;margin-left: 10px;margin-top: 2px;color: #00bba6;">Đăng ký ngay!</a></div>
                    </div>
                    <!--login area start-->
                </div>
            </div>
